...
export const fetchEmployerApplications=()=>async(dispatch)=>{
    ...
    catch(error)
    {
        ...
        dispatch(applicationSlice.actions.failureForAllApplications(error.response.dat.message));
...
export const fetchJobSeekerApplications=()=>async(dispatch)=>{
    ...
    catch(error)
    {
        ...
        dispatch(applicationSlice.actions.failureForMyApplications(error.response.dat.message));

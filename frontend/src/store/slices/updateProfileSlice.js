...
export const updateProfile =(data)=>async(dispatch)=>{
    ...
    try{
        const resposne=await axios.put("http://localhost:4000/api/v1/user/update/profile",data,{
...
dispatch(updateProfileSlice.actions.updateProfileSuccess());
        ...
        dispatch(updateProfileSlice.actions.updateProfileFailed(error.response.data.message || "Failed to Update"));
...
export const updatePassword =(data)=>async(dispatch)=>{
    ...
    try{
        const resposne=await axios.put("http://localhost:4000/api/v1/user/update/password",data,{
            withCredentials:true,
